...
save_mw_cel -as s386_place

### Reports 

report_placement_utilization > output/s386_place_util.rpt
report_qor_snapshot > output/s386_place_qor_snapshot.rpt
report_qor > output/s386_place_qor.rpt
report_power > reports/s386_place_power.rpt
### Timing Report

report_timing -delay max -max_paths 100 > output/s15850_place.setup.rpt
report_timing -delay min -max_paths 100 > output/s15850_place.hold.rpt
